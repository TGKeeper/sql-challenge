...
create table tbl_title (title_id varchar primary key, 
						title varchar);
...
create table tbl_dept (dept_no varchar primary key, 
					   dept_name varchar);
...
create table tbl_deptmngr (dept_no varchar, 
						   emp_no integer,
...
create table tbl_emp_dept (emp_no integer, 
						   dept_no varchar,
						  foreign key (dept_no) references tbl_dept(dept_no),
						  foreign key (emp_no) references tbl_employees(emp_no),
						  primary key (emp_no, dept_no));
